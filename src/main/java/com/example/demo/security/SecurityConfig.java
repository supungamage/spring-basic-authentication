...
import static com.example.demo.security.ApplicationPermissions.COURSE_WRITE;
import static com.example.demo.security.ApplicationPermissions.STUDENT_WRITE;
...
//                .antMatchers(HttpMethod.GET,"/management/api/**").hasAnyRole(ADMIN.name(), SUPER_ADMIN.name())
                .anyRequest()
                .authenticated()
                .and()
                .httpBasic();
